...
class MarketTest < Minitest::Test
  ...
  def test_market_has_no_vendors_by_default_but_can_add_vendors
  ...
  def test_market_can_return_vendors_that_sell_certain_item
    @vendor1.stock(@item1, 35)
    @vendor1.stock(@item2, 7)
    @vendor2.stock(@item4, 50)
    @vendor2.stock(@item3, 25)
    ...
    assert_equal [@vendor1, @vendor3], @market.vendors_that_sell(@item1.name)
    assert_equal [@vendor2], @market.vendors_that_sell(@item4.name)
  end
  ...
  def test_market_can_report_total_inventory
    @vendor1.stock(@item1, 35)
    @vendor1.stock(@item2, 7)
    @vendor2.stock(@item4, 50)
    @vendor2.stock(@item3, 25)
  ...
  def test_if_enough_inventory_to_sell
    @vendor1.stock(@item1, 35)
    @vendor1.stock(@item2, 7)
    @vendor2.stock(@item4, 50)
    @vendor2.stock(@item3, 25)
